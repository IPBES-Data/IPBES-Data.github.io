...
| Name | Role | Details |
|---|---|---|
| rkrug | Project maintainer | Human contributor and repository owner/maintainer. |
| OpenAI Codex | Coding assistant | Model family: GPT-5 (Codex agent). Version: service-managed runtime (session date: 2026-03-09). |
